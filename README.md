...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/opentelemetry-proto-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13876&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/opentelemetry-proto-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `opentelemetry-proto` can be installed with:

```
conda install opentelemetry-proto
```

It is possible to list all of the versions of `opentelemetry-proto` available on your platform with:
