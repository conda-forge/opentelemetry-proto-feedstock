...
pixi add opentelemetry-proto
# for installing globally
pixi global install opentelemetry-proto
```
...
It is possible to list all of the versions of `opentelemetry-proto` available on your platform:
...
```
pixi search opentelemetry-proto --channel conda-forge
```
